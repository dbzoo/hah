...
{                                  
   e.res.type = ET_FILE;           
   e.res.filename = "/www/style/elegant/.svn/format";        
...
extern "C" {                     
#endif                             
void module_init_77d1cfb54b81c5ba840a33143026088f(void);         
void module_init_77d1cfb54b81c5ba840a33143026088f(void)          
{                                  
    res_ctor();                    
    emb_register((embres_t*)&e);   
}                                  
void module_term_77d1cfb54b81c5ba840a33143026088f(void);         
void module_term_77d1cfb54b81c5ba840a33143026088f(void)          
{                                  
