...
{                                  
   e.res.type = ET_FILE;           
   e.res.filename = "/www/style/current/.svn/format";        
...
extern "C" {                     
#endif                             
void module_init_c78e1e76b1b9a3f8538eed9eef8db817(void);         
void module_init_c78e1e76b1b9a3f8538eed9eef8db817(void)          
{                                  
    res_ctor();                    
    emb_register((embres_t*)&e);   
}                                  
void module_term_c78e1e76b1b9a3f8538eed9eef8db817(void);         
void module_term_c78e1e76b1b9a3f8538eed9eef8db817(void)          
{                                  
