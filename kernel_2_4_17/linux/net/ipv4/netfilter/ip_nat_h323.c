...
static struct ip_nat_helper h245 = { { NULL, NULL },
				     { { 0, { 0 } },
				       { 0, { 0 }, IPPROTO_TCP } },
				     { { 0, { 0xFFFF } },
				       { 0, { 0 }, 0xFFFF } },
		  ...
		  struct ip_nat_info *info)
{
	...
	port = exp_info->port;
	is_h225 = master_info->is_h225 == IP_CT_IS_H225;
...
static int h225_nat_mangle(struct ip_conntrack *ct,
			   enum ip_conntrack_info ctinfo,
			   struct sk_buff **pskb)
{
	struct iphdr *iph = (*pskb)->nh.iph;
	...
	return (between(info->seq[IP_CT_DIR_ORIGINAL], ntohl(tcph->seq), ntohl(tcph->seq) + datalen)
...
static struct ip_nat_helper h225 = { { NULL, NULL },
				     { { 0, { __constant_htons(IP_CT_IS_H225) } },
				       { 0, { 0 }, IPPROTO_TCP } },
				     { { 0, { 0xFFFF } },
				       { 0, { 0 }, 0xFFFF } },
				     h225_nat_help, 
