/* $Id$
   ...
   in other words, the CCITT standard CRC-16
    ...
    http://www.koders.com/cpp/fid2A0294B0225688F7CA9C892B993226F5CB4B3F9D.aspx?s=socket 
*/
...
inline void CRC16_InitChecksum( unsigned short *crcvalue ) {
     *crcvalue = CRC16_INIT_VALUE;
}

inline void CRC16_Update( unsigned short *crcvalue, const unsigned char data ) {
...
void CRC16_UpdateChecksum( unsigned short *crcvalue, const void *data, int length ) {
     ...
     crc = *crcvalue;
     while( length-- ) {
	  CRC16_Update(&crc, *buf++);
     }
     *crcvalue = crc;
}

inline void CRC16_FinishChecksum( unsigned short *crcvalue ) {
