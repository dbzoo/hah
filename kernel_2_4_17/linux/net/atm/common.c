...
#endif
#if defined(CONFIG_ATM_RT2684) || defined(CONFIG_ATM_RT2684_MODULE)
int (*rt2684_ioctl_hook)(struct atm_vcc *, unsigned int, unsigned long);
#endif
#ifdef CONFIG_ATM_BR2684_MODULE
EXPORT_SYMBOL(br2684_ioctl_hook);
#endif
#ifdef CONFIG_ATM_RT2684_MODULE
EXPORT_SYMBOL(rt2684_ioctl_hook);
#endif
#endif
...
static int adjust_tp(struct atm_trafprm *tp,unsigned char aal)
{
	...
	switch (aal) {
		...
		case ATM_AAL5:
			...
			/* Use a big max sdu within Linux.  It will be verifigied by the
			 * Broadcom ATM driver.
			 */
		case ATM_AAL2:
		case ATM_BCM_AAL0:
...
#if defined(CONFIG_ATM_RT2684) || defined(CONFIG_ATM_RT2684_MODULE)
        if (rt2684_ioctl_hook) {
                ret_val = rt2684_ioctl_hook(vcc, cmd, arg);
                if (ret_val != -ENOIOCTLCMD)
                        goto done;
        }
#endif
