...
typedef struct
{
    ...
    unsigned char wlan_sprom_ver;//reserved
    unsigned char ucaWlanMacAddr[6];//reserved
...
#define BOARD_IOCTL_GET_MODEL_NAME \
...
typedef struct ledmappair
{
    ...
    unsigned short ledComplement;   // 1: +3V:off, 0V: on   <----> 0: +3V:on, 0V:off
