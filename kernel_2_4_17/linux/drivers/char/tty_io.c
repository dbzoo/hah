...
#ifdef CONFIG_BCM_SERIAL
extern void bcm63xx_console_init(void);
#endif
#if defined(CONFIG_BCM96348_SERIAL)
extern void bcm6348_console_init(void);
#endif
