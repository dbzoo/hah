...
*/
//**************************************************************************************
// File Name  : bcm6345_cons.h
//
// Description:  Head file for serial port driver for BCM96353 board based bcm1100 which based on dz.c 
...
#define DZ_EVENT_FLIP_BUFF_PUSH  1
...
static inline int receive_chars (struct dz_serial *);
