 ...
 * Busybox version: 1.14.4
 */
#define AUTOCONF_TIMESTAMP "2011-12-13 13:25:54 EST"
...
#define CONFIG_CROSS_COMPILER_PREFIX "mips-uclibc-"
...
#define USE_FEATURE_CPIO_P(...)
#define SKIP_FEATURE_CPIO_P(...) __VA_ARGS__
#undef CONFIG_DPKG
...
#define USE_USE_BB_CRYPT_SHA(...)
#define SKIP_USE_BB_CRYPT_SHA(...) __VA_ARGS__
...
#define USE_ACPID(...)
#define SKIP_ACPID(...) __VA_ARGS__
#undef CONFIG_FEATURE_ACPID_COMPAT
#define ENABLE_FEATURE_ACPID_COMPAT 0
#define USE_FEATURE_ACPID_COMPAT(...)
#define SKIP_FEATURE_ACPID_COMPAT(...) __VA_ARGS__
#undef CONFIG_BLKID
...
#define USE_MKFS_VFAT(...)
#define SKIP_MKFS_VFAT(...) __VA_ARGS__
...
#define USE_FEATURE_TUNCTL_UG(...)
#define SKIP_FEATURE_TUNCTL_UG(...) __VA_ARGS__
#undef CONFIG_UDPSVD
...
#define USE_SH_MATH_SUPPORT_64(...)
#define SKIP_SH_MATH_SUPPORT_64(...) __VA_ARGS__
