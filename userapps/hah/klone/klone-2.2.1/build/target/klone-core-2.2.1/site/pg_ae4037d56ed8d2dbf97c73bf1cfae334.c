...
{                                  
   e.res.type = ET_FILE;           
   e.res.filename = "/www/style/current/.svn/text-base/style_ie.css.svn-base";        
...
extern "C" {                     
#endif                             
void module_init_ae4037d56ed8d2dbf97c73bf1cfae334(void);         
void module_init_ae4037d56ed8d2dbf97c73bf1cfae334(void)          
{                                  
    res_ctor();                    
    emb_register((embres_t*)&e);   
}                                  
void module_term_ae4037d56ed8d2dbf97c73bf1cfae334(void);         
void module_term_ae4037d56ed8d2dbf97c73bf1cfae334(void)          
{                                  
