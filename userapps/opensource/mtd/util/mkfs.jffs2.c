...
/* $Id: mkfs.jffs2.c,v 1.1.1.1 2003/02/28 09:18:55 cmo Exp $ */

//#define DMALLOC
//#define mkfs_debug_msg	error_msg
#define mkfs_debug_msg(...)	{ }
...
extern unsigned char jffs2_compress(unsigned char *data_in, 
		unsigned char *cpage_out, __u32 * datalen, __u32 * cdatalen);
...
static __u32 highest_ino = 1;
static __u32 version;
...
static void output_pipe(__u32 ino, struct stat *statbuf)
{
	struct jffs2_raw_inode ri;
