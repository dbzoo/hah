...
Sub Docode(byval Idx As Byte)
  ...
  For J = 1 To 25                                           'BBSB uses 25bits
    D = Rf(idx).bp                                          ' bit 0|1 Hi/Lo

    Set Awire                                               'we start the pulse
    If D = 0 Then                                           'encode for a 0 bit
      Waitus 375
      Reset Awire
      Waitus 1125
    Else                                                    'encode for a 1 bit
      Waitus 1125
      Reset Awire
      Waitus 375
    End If
