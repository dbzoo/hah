 ...
 *
 * Description: This file contains the flash device driver calls for bcm63xx board. 
 *
...
//        if (copy_from_user((void *)pTempBuf,(void *)string, sect_size) != 0)
//            break;  // failed ?

        flash_ub(0);
//        if ((i = flash_write_buf_ub(blk_start, 0, pTempBuf, sect_size)) != sect_size) {
