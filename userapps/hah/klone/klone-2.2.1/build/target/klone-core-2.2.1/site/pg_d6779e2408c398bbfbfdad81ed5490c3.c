...
{                                  
   e.res.type = ET_FILE;           
   e.res.filename = "/www/style/current/style_ie.css";        
...
extern "C" {                     
#endif                             
void module_init_d6779e2408c398bbfbfdad81ed5490c3(void);         
void module_init_d6779e2408c398bbfbfdad81ed5490c3(void)          
{                                  
    res_ctor();                    
    emb_register((embres_t*)&e);   
}                                  
void module_term_d6779e2408c398bbfbfdad81ed5490c3(void);         
void module_term_d6779e2408c398bbfbfdad81ed5490c3(void)          
{                                  
