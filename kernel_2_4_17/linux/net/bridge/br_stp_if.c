 ...
 *
 *	$Id: br_stp_if.c,v 1.2 2004/03/25 18:12:35 cmo Exp $
 *
...
void br_stp_recalculate_bridge_id(struct net_bridge *br)
{
	...
	while (p != NULL) {
		...
		if (addr == br_mac_zero ||
		  ...
		  addr = p->dev->dev_addr;
	 	  break;	/* INV CMO : pour que le bridge ne change pas d'adresse MAC sans arrêt, 
				   et qu'il utilise l'adresse de la première interface de sa liste.
				 */
		}
#endif
		addr = p->dev->dev_addr;
